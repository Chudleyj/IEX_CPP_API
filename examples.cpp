/* UNOFFICIAL IEX TRADING API WITH EXAMPLES for C++
 BY: Justin Chudley
...
/*THIS MAIN FUNCTION SHOULD NOT BE HERE, IF YOU ARE TRYING TO USE THE REAL API THEN DO NOT USE THIS FILE
 THIS IS FOR SHOWING EXAMPLES OF EACH FUNCTION ONLY */
int main(){
